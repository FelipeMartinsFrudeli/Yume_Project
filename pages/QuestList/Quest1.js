    ...
    return (
        <div>
            ...
            <div className={style.Container}>
                <Card 
                    image={style.Robot} 
                    Titulo={<h1>A queda das <a style={{color:'#37C2CA'}}>redes</a></h1>}
                    Texto={<div className={style.SecondText}><p>Em um dia fatídico, todas as redes sociais cairam, o mundo<br/>
                        entrou em pânico e ainda não se sabe quem causou essa<br/>
                        fatalidade. Você e sua equipe foram encarregados de desvendar<br/>
                        esse mistério, para isso você terá de seguir as pistas<br/>pessoalmente.</p>
                        <p>Nesse quiz, você se deparará com 5 problemas que se passam<br/> 
                        dentro desse dilema. Pense como usar as soft skills para<br/> 
                        solucionar os desafios da melhor maneira possível</p>
                        </div>}
                />
                <QuestCard
                    id='Card1'
