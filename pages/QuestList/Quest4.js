...
import Card from '../components/RightCard';
    ...
    return (
        <div>
            ...
            <div className={style.Container}>
                <Card 
                    image={style.ChessIcon} 
                    Titulo={<h1>A <a style={{color:'#37C2CA'}}>revolta</a> dos peões</h1>}
                    Texto={<div className={style.SecondText}><p>É ano de 1789 e você e sua equipe são líderes da Revolução<br/>
                        Francesa. Para garantir o melhor futuro possível, vocês terão<br/>
                        de lidar com questões políticas e sociais. Lembrem-se, suas<br/>
                        escolhas podem mudar o final dessa história.</p>
